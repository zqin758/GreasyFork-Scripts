...
### version 2026.05.02.1 - 更新日志： 【🔥[安装此脚本](https://github.com/F9y4ng/GreasyFork-Scripts/raw/master/Font%20Rendering.user.js)】

```log
@ 改进字体渲染粗体描边样式修正函数的性能。
@ 改进站点缩放设置数据规则：域名匹配可包含端口号。
@ 改进 iframe 框架页面跨源通信的发送模式。
@ 优化增强对 GM_API::GM_addElement 的支持。
@ 优化脚本核心基础函数以提升运行性能。
@ 修正一些已知问题，优化代码，优化样式。
```
...
### version 2026.05.04.1 - 更新日志： 【🔥 [安装此脚本](https://github.com/F9y4ng/GreasyFork-Scripts/raw/master/Google%20%26%20Baidu%20Switcher.user.js)】
...
### version 2026.01.01.1 - 更新日志： 【🔥 [安装此脚本](https://github.com/F9y4ng/GreasyFork-Scripts/raw/master/Autoclose%20Zhihu%20Login.user.js)】
